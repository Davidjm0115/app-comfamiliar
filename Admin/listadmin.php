      ...
      include("./logica/db.php");
        ...
        echo"
                <tr style='color: #000;'>
                  ...
                  <td><center><a href='actualizaradmin.php?id=".$consulta['USUARIO_ID']."'><button class='btn btn-primary'><i class='zmdi zmdi-refresh'> Editar</button></center></td>
                  
                  <td><center><a href='./logica/eliminaradmin.php?id=".$consulta['USUARIO_ID']."' class='eliminar'><button class='btn btn-danger'>Eliminar  <i class='zmdi zmdi-delete'></i></button><a></center></td>
                </tr>
            ";
          }?>
</tbody></table>
