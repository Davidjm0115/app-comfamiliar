                ...
                <?php 
                 ...
                 $resultados = mysqli_query($conexion,"SELECT * FROM configuracion");
                    ...
                    {?>
                            ...
                            <form class="form-padding" method='POST' action='./logica/actualizar2insti.php'>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="nombre" value="<?php echo $consulta['nombre_empresa']?>"  placeholder="Nombre de la institución" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la institución">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="direccion" value="<?php echo $consulta['direccion']?>" placeholder="Direccion de la institución" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,20}" maxlength="20" data-toggle="tooltip" data-placement="top" title="Solo números, máximo 20 caracteres" >
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="tel" value="<?php echo $consulta['telefono']?>" placeholder="Teléfono de la institución" required="" pattern="{10,10}" maxlength="10" data-toggle="tooltip" data-placement="top" title="Solo 10 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="email" class="form-control" name="correo" value="<?php echo $consulta['correo']?>" placeholder="Correo de la institución" required=""  maxlength="50" data-toggle="tooltip" data-placement="top" title="Solo números, máximo 50 caracteres">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="pais" value="<?php echo $consulta['pais']?>" placeholder="Pais de la institución" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el pais de la institución">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="ciudad" value="<?php echo $consulta['ciudad']?>" placeholder="Ciudad de la institución" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe la ciudad de la institución">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="pagina" value="<?php echo $consulta['paginaweb']?>" placeholder="Pagina web" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ. ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe la pagina web de la institución">
                                <span class="highlight"></span>
                                <span class="bar"></span>
