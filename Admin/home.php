    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        <nav class="navbar-user-top full-reset">
            <ul class="list-unstyled full-reset">
                ...
                <li  class="tooltips-general exit-system-button" data-href="./logica/salir.php" data-placement="bottom" title="Salir del sistema">
        ...
        <div class="container">
            ...
            <div class="jumbotron"><h1>SISTEMA BIBLIOTECARIO</h1><br>
              <img src="assets/img/holis.png"><br><br>
              <h1>BIENVENIDO <?php $usuario = $_SESSION['usuario']; $nombre=$usuario['NOMBRE_USU'];  echo $nombre;?></h1></div>
