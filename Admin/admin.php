    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" action="./logica/insertaadmin.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                            <p style="padding-top: 15px">Usuario ID</p>
                                <input type="text" class="form-control" placeholder="ID de usuario" name="usuid" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Escribe un nombre de usuario sin espacios, que servira para iniciar sesión">
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                            <p style="padding-top: 15px">Nombre de Usuario</p>
                                <input type="text" class="form-control" placeholder="Nombre de usuario" name="nomusu" required="" maxlength="20" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" data-toggle="tooltip" data-placement="top" title="Escribe un nombre de usuario sin espacios, que servira para iniciar sesión">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="password" class="form-control" placeholder="Contraseña" name="pass" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                           <div class="group-material">
                                ...
                                <select class="form-control" name="usunivel"  data-toggle="tooltip" data-placement="top" title="Elige la sección a la que pertenece el alumno">
