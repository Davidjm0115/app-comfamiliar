    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" method="POST" action="./logica/insertarcate.php">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <p  style="padding-top: 15px">Codigo de herramienta</p>
                                <input type="text"class="form-control" name="codcat" placeholder="Escribe aquí el código de categoría"  required="" pattern="[0-9]{1,20}" maxlength="2" data-toggle="tooltip" data-placement="top" title="Solo números, máximo 2 caracteres">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                <p  style="padding-top: 15px">Nombre de la categoria</p>
                                <input type="text" class="form-control" name="nomcat" placeholder="Escribe aquí el nombre de la categoría" required="" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre de la categoría">
                                <span class="highlight"></span>
                                <span class="bar"></span>
