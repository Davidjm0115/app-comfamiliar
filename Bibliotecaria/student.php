    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" method="POST" action="insertarusu.php">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="numid"  placeholder="Escribe aquí el ID del alumno" required="" maxlength="20" data-toggle="tooltip" data-placement="top" title="ID de estudiante">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="pnombre" placeholder="Escribe aquí los nombres del alumno" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombre del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="snombre" placeholder="Escribe aquí los apellidos del alumno" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Nombre del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                            ...
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="papellido" placeholder="Escribe aquí los nombres del alumno" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Apellido del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="sapellido" placeholder="Escribe aquí los apellidos del alumno" required="" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,50}" maxlength="50" data-toggle="tooltip" data-placement="top" title="Apellido del estudiante">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12">
                           <div class="group-material">
                                ...
                                <select class="form-control" name="categoria" data-toggle="tooltip" data-placement="top" title="Elige la sección a la que pertenece el alumno">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="email" class="form-control" name="correo" placeholder="yourmail@example.com" required=""  maxlength="30" data-toggle="tooltip" data-placement="top" title="Parentesco">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text" class="form-control" name="tel" placeholder="Teléfono" pattern="[0-9]{8,8}" required="" maxlength="8" data-toggle="tooltip" data-placement="top" title="Solamente 8 números">
                                <span class="highlight"></span>
                                <span class="bar"></span>
