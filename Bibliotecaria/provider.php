    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-padding" action="./logica/insertaprove.php" method="POST">
                    <div class="row">
                        <div class="col-xs-12">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                             <p style="padding-top: 15px">Nombre Proveedor</p>
                                <input type="text" class="form-control" name="nompro" placeholder="Nombre de proveedor" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del proveedor">
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text"  class="form-control" name="producto" placeholder="Producto" required="" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1," maxlength="20" data-toggle="tooltip" data-placement="top" title="Solo números, mínimo 8 dígitos">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text"  class="form-control" name="pais" placeholder="Pais" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe pais del proveedor">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text"  class="form-control" name="ciudad" placeholder="Ciudad" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ]{1,20}"required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe Ciudad del proveedor">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="group-material">
                                ...
                                <input type="text"  class="form-control" name="provid" placeholder="Proveedor ID" required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el ID del proveedor">
                                <span class="highlight"></span>
                                <span class="bar"></span>
